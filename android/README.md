# Sentiment Analysis Android SDK
...
```gradle
dependencies {
    implementation 'com.github.apiverve:sentimentanalysis-api:1.1.12'
}
```
...
```java
import com.apiverve.sentimentanalysis.SentimentAnalysisAPIClient;
import com.apiverve.sentimentanalysis.APIResponse;
import com.apiverve.sentimentanalysis.APIException;

// Initialize the client
SentimentAnalysisAPIClient client = new SentimentAnalysisAPIClient("YOUR_API_KEY");
...
For detailed API documentation, visit: [https://docs.apiverve.com/ref/sentimentanalysis](https://docs.apiverve.com/ref/sentimentanalysis)
...
- **Documentation:** [https://docs.apiverve.com/ref/sentimentanalysis](https://docs.apiverve.com/ref/sentimentanalysis)
- **Issues:** [GitHub Issues](https://github.com/apiverve/sentimentanalysis-api/issues)
